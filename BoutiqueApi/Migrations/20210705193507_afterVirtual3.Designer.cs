...
namespace BoutiqueApi.Migrations
{
    ...
    [Migration("20210705193507_afterVirtual3")]
    partial class afterVirtual3
    {
            ...
            modelBuilder.Entity("BoutiqueApi.Data.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RecordDate = new DateTime(2021, 7, 5, 22, 35, 7, 0, DateTimeKind.Local).AddTicks(8110)
                        },
                        new
                        {
                            Id = 2,
                            Key = "TestKey2",
                            Platform = "TestPlatform",
                            RecordDate = new DateTime(2021, 7, 5, 22, 35, 7, 4, DateTimeKind.Local).AddTicks(6710)
                        });
                });
            ...
            modelBuilder.Entity("BoutiqueApi.Data.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RecordDate = new DateTime(2021, 7, 5, 22, 35, 7, 4, DateTimeKind.Local).AddTicks(8120),
                            Title = "Test Title"
                        },
                        new
                        {
                            ...
                            RecordDate = new DateTime(2021, 7, 5, 22, 35, 7, 4, DateTimeKind.Local).AddTicks(8840),
                            Title = "Test Title"
                        });
                });
            ...
            modelBuilder.Entity("BoutiqueApi.Data.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2021, 7, 5, 22, 35, 7, 5, DateTimeKind.Local).AddTicks(8090),
                            OrderStatus = "TestStatus",
                            PaymentDate = new DateTime(2021, 7, 5, 22, 35, 7, 5, DateTimeKind.Local).AddTicks(8770),
                            PaymentStatus = "TestStatus",
                            PhoneNumber = "12345678",
                            ShipmentDate = new DateTime(2021, 7, 5, 22, 35, 7, 5, DateTimeKind.Local).AddTicks(9830),
                            TotalPrice = 20m,
                            TransactionId = 1
                        },
                        new
                        {
                            ...
                            Email = "test@testmail.com",
                            FullName = "Test Name Test Surname",
                            OrderDate = new DateTime(2021, 7, 5, 22, 35, 7, 6, DateTimeKind.Local).AddTicks(950),
                            OrderStatus = "TestStatus",
                            PaymentDate = new DateTime(2021, 7, 5, 22, 35, 7, 6, DateTimeKind.Local).AddTicks(950),
                            PaymentStatus = "TestStatus",
                            PhoneNumber = "12345678",
                            ShipmentDate = new DateTime(2021, 7, 5, 22, 35, 7, 6, DateTimeKind.Local).AddTicks(960),
                            TotalPrice = 20m,
                            TransactionId = 1
                        });
                });
