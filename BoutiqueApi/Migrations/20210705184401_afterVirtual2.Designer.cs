...
namespace BoutiqueApi.Migrations
{
    ...
    [Migration("20210705184401_afterVirtual2")]
    partial class afterVirtual2
    {
            ...
            modelBuilder.Entity("BoutiqueApi.Data.Device", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RecordDate = new DateTime(2021, 7, 5, 21, 44, 1, 33, DateTimeKind.Local).AddTicks(9930)
                        },
                        new
                        {
                            Id = 2,
                            Key = "TestKey2",
                            Platform = "TestPlatform",
                            RecordDate = new DateTime(2021, 7, 5, 21, 44, 1, 37, DateTimeKind.Local).AddTicks(8740)
                        });
                });
            ...
            modelBuilder.Entity("BoutiqueApi.Data.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RecordDate = new DateTime(2021, 7, 5, 21, 44, 1, 38, DateTimeKind.Local).AddTicks(30),
                            Title = "Test Title"
                        },
                        new
                        {
                            ...
                            RecordDate = new DateTime(2021, 7, 5, 21, 44, 1, 38, DateTimeKind.Local).AddTicks(790),
                            Title = "Test Title"
                        });
                });
